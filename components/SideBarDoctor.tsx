"use client";
import { NAV_LINKS_DOCTOR } from "@/constant";
...
const SideBarDoctor = () => {
  ...
  // Check if we should hide sidebar on certain pages
  if (
    pathname === "/logout" ||
    pathname === "/doctor/writingReport" ||
    pathname === "/doctor/viewimg"
  ) {
    return null;
  }
