          ...
          <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-5 md:gap-12 text-white">
            ...
            <div className="grid grid-cols-1 gap-4 content-center pl-0">
              <div className="flex items-center gap-4">
                ...
                <span className="text-base md:text-lg text-white">T001</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-base md:text-lg text-white">10</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-base md:text-lg text-white">Female</span>
              </div>
